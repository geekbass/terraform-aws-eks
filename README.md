...
| <a name="input_node_groups"></a> [node\_groups](#input\_node\_groups) | Map of maps of eks node groups to create. | `any` | <pre>{<br>  "example": {<br>    "ami_type": "AL2_x86_64",<br>    "capacity_type": "ON_DEMAND",<br>    "desired_number_workers": 2,<br>    "disk_size": 50,<br>    "instance_types": [<br>      "t2.medium"<br>    ],<br>    "k8s_labels": {<br>      "environment": "default",<br>      "name": "default"<br>    },<br>    "max_number_workers": 2,<br>    "min_number_workers": 2,<br>    "name": "default",<br>    "subnet_ids": [],<br>    "tags": {},<br>    "taints": []<br>  }<br>}</pre> | no |
